...
int main()
{
    ...
    text:
        ...
        if (language == "English")
        {
            ...
            minecraftProcessNotFound = "Minecraft process not found, starting Minecraft.";
        ...
        else if (language == "Japanese")
        {
            ...
            minecraftProcessNotFound = "Minecraftプロセスが見つかりませんでした, マインクラフトを起動します。";
        ...
        else if (language == "Korean")
        {
            ...
            minecraftProcessNotFound = "Minecraft 프로세스를 찾을 수 없습니다, Minecraft를 시작합니다.";
        ...
        else if (language == "Chinese (繁體)")
        {
            ...
            minecraftProcessNotFound = "Minecraft 進程未找到,正在啟動Minecraft.";
        ...
        else if (language == "Chinese (簡體)")
        {
            ...
            minecraftProcessNotFound = "Minecraft 进程找到,正在启动Minecraft.";
...
Injector_DLL:
                ...
                if (PID == 0)
                {
                    ...
                    LPCTSTR minecraftURL = _T("minecraft:");

                    // 開啟 Minecraft URL
                    ShellExecute(NULL, _T("open"), minecraftURL, NULL, NULL, SW_SHOWDEFAULT);
